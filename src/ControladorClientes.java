...
public class ControladorClientes {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while (validez){
                        ...
                        while (auxiliar != null) {
                            ...
                            if (auxiliar.getNIF().equals(NIF)) {
                                ...
                                do {
                                    ...
                                    System.out.print("Introduzca de nuevo el NIF del cliente: ");
                                    NIF = teclado.next();
            ...
            if (entrada.equals("5")) {
                ...
                FileOutputStream eliminar = new FileOutputStream("C:\\Users\\ursaa\\IdeaProjects\\ClientesBanco\\cliente.info.txt");
                //File ficheroEliminar = new File ("C:\\Users\\ursaa\\IdeaProjects\\ClientesBanco\\cliente.info.txt");
    ...
    public static void borrarCliente (String borrarNIF) {
        ...
        ficheroEntrada =new File("C:\\Users\\ursaa\\IdeaProjects\\ClientesBanco\\cliente.info.txt");
        ficheroSalida = new File("C:\\Users\\ursaa\\IdeaProjects\\ClientesBanco\\temporal.info.txt");
